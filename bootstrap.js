...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.locale.pt_BR.Component": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.form.field.Base": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.form.field.ComboBox": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.form.field.Date": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.form.field.HtmlEditor": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.form.field.Number": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.form.field.Text": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.form.field.VTypes": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.grid.PropertyColumnModel": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.grid.header.Container": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.grid.plugin.DragDrop": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.picker.Date": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.picker.Month": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.tab.Tab": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.toolbar.Paging": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.view.AbstractView": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.view.View": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
  "Ext.locale.pt_BR.window.MessageBox": "ext/packages/ext-locale/overrides/pt_BR/ext-locale-pt_BR.js",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Ext.locale.pt_BR.Component": [],
  "Ext.locale.pt_BR.form.field.Base": [],
  "Ext.locale.pt_BR.form.field.ComboBox": [],
  "Ext.locale.pt_BR.form.field.Date": [],
  "Ext.locale.pt_BR.form.field.HtmlEditor": [],
  "Ext.locale.pt_BR.form.field.Number": [],
  "Ext.locale.pt_BR.form.field.Text": [],
  "Ext.locale.pt_BR.form.field.VTypes": [],
  "Ext.locale.pt_BR.grid.PropertyColumnModel": [],
  "Ext.locale.pt_BR.grid.header.Container": [],
  "Ext.locale.pt_BR.grid.plugin.DragDrop": [],
  "Ext.locale.pt_BR.picker.Date": [],
  "Ext.locale.pt_BR.picker.Month": [],
  "Ext.locale.pt_BR.tab.Tab": [],
  "Ext.locale.pt_BR.toolbar.Paging": [],
  "Ext.locale.pt_BR.view.AbstractView": [],
  "Ext.locale.pt_BR.view.View": [],
  "Ext.locale.pt_BR.window.MessageBox": [],
  "Ext.menu.CheckItem": [],
  ...
  "mypms.Application": [],
  "mypms.controller.Servidores": [],
  "mypms.controller.autentica": [],
  ...
  "mypms.model.paineladm.tab.appambproj": [],
  ...
  "mypms.model.redeip.redeipsubnivel": [],
  "mypms.model.redeip.redeiptipo": [],
  "mypms.model.redeip.tipo": [],
  "mypms.model.zonaunica.bizu": [],
  "mypms.model.zonaunica.nivelacesso": [],
  "mypms.store.admadlogin": [],
  "mypms.store.ambiente": [],
  "mypms.store.appadm": [],
  "mypms.store.appadmlogin": [],
  "mypms.store.appadmnivel": [],
  "mypms.store.appadmproj": [],
  ...
  "mypms.view.servidores.gridEditor": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "mypms.model.gridServidores.servidores": [],
  "mypms.model.historico.historicobizu": [
    "model.historico.historicobizu"
  ],
  "mypms.model.historico.historicoip": [],
  "mypms.model.historico.historicosrv": [],
  "mypms.model.paineladm.tab.admadlogin": [
    "model.paineladm.admadlogin"
  ],
  "mypms.model.paineladm.tab.ambiente": [
    "model.paineladm.ambiente"
  ],
  "mypms.model.paineladm.tab.appadm": [
    "model.paineladm.appadm"
  ],
  "mypms.model.paineladm.tab.appambdyn": [
    "model.paineladm.appambdyn"
  ],
  "mypms.model.paineladm.tab.appamblogin": [
    "model.paineladm.appamblogin"
  ],
  "mypms.model.paineladm.tab.appambproj": [
    "model.paineladm.appambproj"
  ],
  "mypms.model.paineladm.tab.appprojdyn": [
    "model.paineladm.appprojdyn"
  ],
  "mypms.model.paineladm.tab.descricao": [
    "model.paineladm.descricao"
  ],
  "mypms.model.paineladm.tab.local": [
    "model.paineladm.local"
  ],
  "mypms.model.paineladm.tab.modeloapp": [
    "model.paineladm.modeloapp"
  ],
  "mypms.model.paineladm.tab.os": [
    "model.paineladm.os"
  ],
  "mypms.model.paineladm.tab.pais": [
    "model.paineladm.pais"
  ],
  "mypms.model.paineladm.tab.projeto": [
    "model.paineladm.projeto"
  ],
  "mypms.model.paineladm.tab.rede": [
    "model.paineladm.rede"
  ],
  "mypms.model.paineladm.tab.tipoapp": [
    "model.paineladm.tipoapp"
  ],
  "mypms.model.paineladm.tab.tiposrv": [
    "model.paineladm.tiposrv"
  ],
  "mypms.model.redeip.redeip": [
    "model.redeip.redeip"
  ],
  "mypms.model.redeip.redeipnivel": [
    "model.redeip.redeipnivel"
  ],
  "mypms.model.redeip.redeipsubnivel": [
    "model.redeip.redeipsubnivel"
  ],
  "mypms.model.redeip.redeiptipo": [
    "model.redeip.redeiptipo"
  ],
  "mypms.model.redeip.tipo": [
    "model.redeip.tipo"
  ],
  "mypms.model.zonaunica.bizu": [
    "model.zonaunica.bizu"
  ],
  "mypms.model.zonaunica.nivelacesso": [
    "model.zonaunica.nivelacesso"
  ],
  "mypms.store.admadlogin": [],
  "mypms.store.ambiente": [
    "widget.paineladmAmb"
  ...
  "mypms.store.descricao": [
    "widget.paineladmDesc"
  ],
  "mypms.store.historicobizu": [
    "widget.historicobizu"
  ],
  "mypms.store.historicoip": [
    "widget.historicoip"
  ],
  ...
  "mypms.store.local": [
    "widget.paineladmLocal"
  ],
  "mypms.store.modeloapp": [
    "widget.paineladmModeloapp"
  ],
  "mypms.store.nivelacesso": [
    "widget.nivelacesso"
  ],
  ...
  "mypms.store.pais": [
    "widget.paineladmPais"
  ],
  "mypms.store.projeto": [
    "widget.paineladmProj"
  ],
  "mypms.store.rede": [
    "widget.paineladmRede"
  ],
  "mypms.store.redeip": [
    "widget.redeip"
  ],
  ...
  "mypms.store.tipoapp": [
    "widget.paineladmtipoapp"
  ],
  "mypms.store.tiposrv": [
    "widget.paineladmTiposrv"
  ],
  "mypms.view.Main": [
    "widget.app-main"
  ],
  ...
  "mypms.view.historico.gridbizu": [
    "widget.gridhistoricobizu"
  ],
  "mypms.view.historico.gridhistorico": [
    "widget.gridhistorico"
  ],
  "mypms.view.historico.gridip": [
    "widget.gridhistoricoip"
  ],
  "mypms.view.historico.winhistorico": [
    "widget.winhistorico"
  ],
  "mypms.view.historico.winhistoricobizu": [
    "widget.winhistoricobizu"
  ],
  "mypms.view.historico.winhistoricoip": [
    "widget.winhistoricoip"
  ],
  "mypms.view.paineladm.admin": [
    "widget.painelAdm"
  ],
